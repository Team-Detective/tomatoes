...
const baseTagStyle =
  'h-[33px] px-2 py-[3px] rounded-[999px] justify-center items-center gap-1.5 inline-flex flex-wrap min-w-[85px] max-w-[120px] text-sm sm:text-sm md:text-base';
...
const textStyles = {
  ...
  completed: `${baseTextStyle} text-sub-gray-300`,
  ...
  if (type === 'active' && color) {
    return (
      <div className={tagStyles.active[color]}>
        ...
        />
        <span className={textStyles.active[color]}>D-{day}</span>
      </div>
    );
    ...
    return (
      <div className={tagStyles['completed']}>
        <img
          ...
          className={`min-w-[24px] min-h-[24px]`}
        />
        <span className={textStyles['completed']}>마감</span>
      </div>
    );
  } else {
    // upcoming
    return (
      <div className={tagStyles['upcoming']}>
        <img
          ...
          className={`min-w-[24px] min-h-[24px]`}
        />
        <span className={textStyles['upcoming']}>예정</span>
      </div>
    );
  }
}
